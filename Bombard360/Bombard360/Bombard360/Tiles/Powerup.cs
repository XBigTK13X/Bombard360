    ...
    class Powerup:GameplayObject
    {
        ...
        public override void Update()
        {
            if (BoardManager.HasTileType(m_position, SpriteType.PLAYER_STAND) || BoardManager.HasTileType(m_position, SpriteType.PLAYER_WALK))
            {
                ...
                Player temp = (Player)BoardManager.GetTileType(m_position, SpriteType.PLAYER_STAND);
                Player temp2 = (Player)BoardManager.GetTileType(m_position, SpriteType.PLAYER_WALK);
                if (null != temp)
                {
